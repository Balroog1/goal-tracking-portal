    ...
    <div className="flex items-center justify-between mb-10 bg-white/5 border border-white/10 rounded-3xl px-6 py-4">
      ...
      <div>
        ...
        <p className="text-gray-400">
          Track goals and employee performance.
        </p>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="bg-white/10 hover:bg-white/20 transition p-3 rounded-xl">
          🔔
        </button>

        <div className="bg-blue-600 w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg">
          A
        </div>
